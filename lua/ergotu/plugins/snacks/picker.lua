...
return {
  {
    ...
    keys = {
      ...
      { "<leader><space>", function() Snacks.picker.smart({cwd = Util.root()}) end, desc = "Smart Picker (Buffers/Recent/Files)" },
      ...
      { "<leader>fF", function() Snacks.picker.files({cwd = Util.root.cwd()}) end, desc = "Find Files (cwd)" },
      ...
      { "<leader>sG", function () Snacks.picker.grep({cwd = Util.root.cwd()}) end, desc = "Grep (cwd)" },
      ...
      { "<leader>sW", function () Snacks.picker.grep_word({cwd = Util.root.cwd()}) end, desc = "Visual selection or word (cwd)", mode = { "n", "x" } },
      -- search
